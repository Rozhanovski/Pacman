...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        ghost = new ImageIcon("images/Ghost2.gif").getImage();
        ghost = new ImageIcon("images/GhostScared1.gif").getImage();
        ghost = new ImageIcon("images/GhostScared2.gif").getImage();
